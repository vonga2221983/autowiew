    ...
    with sync_playwright() as p:
        while time.time() < end_time:
            ...
            try:
                ...
                # log mỗi 20s để tránh job bị kill
                for _ in range(OPEN_MINUTES * 3):
            ...
            for _ in range(rest * 3):
                time.sleep(20)  # log liên tục để tránh GitHub Actions kill
